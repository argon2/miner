...
void cpu_manager::set_work(const std::shared_ptr<getwork_work> & val)
{
    log_debug("CPU manager is setting (getwork) work.");
...
{
    log_debug("CPU manager is setting (stratum) work.");
