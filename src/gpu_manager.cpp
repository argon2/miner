...
void gpu_manager::set_work(const std::shared_ptr<getwork_work> & val)
{
    log_debug("GPU manager is setting (getwork) work.");
...
{
    log_debug("GPU manager is setting (stratum) work.");
